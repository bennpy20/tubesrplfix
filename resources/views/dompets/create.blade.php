<form action="{{ route('dompets.store') }}" method="POST" class="p-4 md:p-5" autocomplete="off">
    @csrf
    <div class="grid gap-4 mb-4 grid-cols-2">
        <div class="col-span-2">
            ...
            form-control @error('label') is-invalid @enderror" value="{{ old('label') }}" placeholder="Masukkan nama dompet" required />
